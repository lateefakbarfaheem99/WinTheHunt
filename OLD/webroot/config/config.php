...
// the self-installation script.
        ...
        'App' => array(
		'license'                => 'phpPA-dbdb1c0d393ac10', // you don't need to change this, it's automatically added by the Installer
		'encoding'               => 'utf-8', // the default encoding/charset, detected by the installer
		'baseUrl'                => '',
		'base'                   => '',
		'dir'		    		 => '',
		'webroot'				 => 'webroot',
		'name'                   => 'Your Site Name', // your website title
		'url'                    => 'http://www.winthehunt.com',
		'ref_url'                => 'http://www.winthehunt.com',
		'nml_url'                => 'http://www.winthehunt.com',
		'serverName'             => '',
		'timezone'               => 'America/New_York',  // check the Time Zone article in the Knowledge Base for the correct 
		'language'               => 'eng', // Three-letter only, eng = English
		'email'                  => 'dave@winthehunt.com',
		'currency'               => 'USD', // Three-letter currency code, i.e. GBP, USD, CAD, for more information see the Knowledge base article on custom currencies.
...
// third-party option below (currently commented out).
        ...
        'Email' => array( 
            ...
            'Port'       => 25,
            'WordWrap'   => 50,
            'From'       => 'no-reply@www.winthehunt.com', // IMPORTANT: make sure there's no "www." here
            'FromName'   => 'Your Site Name',
            'ReplyTo'    => 'dave@winthehunt.com'
   ...
   /*
        'Email' => array(
            ...
            'FromName'   => 'Your Site Name',
            'ReplyTo'    => 'info@www.winthehunt.com'
        ),*/
...
// Panel once enabled.
        ...
        'Stats'=>array(
		'enabled'=>true,		//if set to false, stats logging is disabled. Reduces MySQL load
