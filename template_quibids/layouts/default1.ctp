...
window.onload=function(){
  ...
  var loopTime=setInterval("currentTime()",30000);  // 6000 = 10mins, 30000 = 5 mins Dave Hofer Changed This
}
...
<img src="/img/banner.jpg" />
  ...
  <div id="MainNav">
    <ul>
      ...
      <!--class="Active"-->
      <li><a class="<?php echo $froozleClass;?>" href="<?php echo $appConfigurations['nml_url'];?>/packages">GET BIDS</a></li>
