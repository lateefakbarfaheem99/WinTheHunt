<style>
.howfind {display:inline;float:left;font-size:1.3em;margin-right:10px;text-align:right; width:181px;}
.radio-group { margin:0;padding:0;width:60%;}
.verification { display: inline;float: left;font-size: 1.3em;margin-right: 10px;padding-bottom: 8px;text-align: left;width: 122px; }
.submit { margin:10px 0 0 122px !important;
...
<div class="box clearfix">
	...
	<div class="f-repeat clearfix">
		<div class="content">
			...
			<fieldset>
				<label class="howfind"><?php __('How did you find us? *');?></label>
