...
<div class="Content">
	...
	<div class="module">
		...
		<ul class="menu2">
			<li><?php echo $html->link(__('Get Points', true), array('controller' => 'packages', 'action' => 'index'));?></li>
		...
		<ul class="menu2">
			<li><?php echo $html->link(__('My Points', true), array('controller' => 'bids', 'action' => 'index'));?></li>
