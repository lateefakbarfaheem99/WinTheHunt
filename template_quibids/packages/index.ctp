		...
		<div class="content">
			...
			<div id="rightcol">
				...
				<tr>
					...
					<th><?php echo $paginator->sort('Number of Points', 'bids');?></th>
					...
					<tr<?php echo $class;?>>
						...
						<td class="actions">
							...
							<?php if(Configure::read('Paypal.email')<>'') : ?>
								<?php echo $html->link(__('Purchase Using Credit Card', true), array('controller' => 'payment_gateways', 'action' => 'paypal', 'package', $package['Package']['id'])); ?><br>
							<?php endif; ?>
