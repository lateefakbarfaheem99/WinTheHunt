...
$var = $_SESSION['Message']['flash']['message'];
if($var == 'You have successfully logged in.'){
	$redirect = true;
	unset($_SESSION['Message']);
}
if($redirect){
	echo '<script>window.location.href="/auctions/home";</script>';
}
	...
	function _checkAuth(){
		...
		$this->Auth->loginRedirect = array('controller' => 'auctions', 'action' => 'home');
