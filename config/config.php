...
// Sample of db connection moved to another server.
//
//    $config = array(
//        'Database' => array(
//            'driver'     => 'mysql',
//            'persistent' => false,
//            'host'       => '10.181.161.115', // MySQL Hostname, usually 'localhost'
//            'login'      => 'root', // MySQL Username
//            'password'   => 'Xwe23goQh', // MySQL Password
//            'database'   => 'WinTheHunt', // MySQL Database Name
...
//        ),
    ...
    $config = array(
        'Database' => array(
            ...
            'login'      => 'APP2', // MySQL Username
            'password'   => 'WinTheMoney$1', // MySQL Password
            'database'   => 'WinTheHunt', // MySQL Database Name
            'prefix'     => '', // not usually required, leave blank
            'encoding'	 => 'utf8' 
        ),
...
// Support Center for assistance.
        ...
        'App' => array(
		'license'                => 'phpPA-dbdb1c0d393ac10', // Paste your license key from the Support Center here (begins with 'phpPA-')
		'encoding'               => 'UTF-8',
		...
		'webroot'				 => 'webroot',
		'name'                   => 'WinTheHunt',
		'url'                    => 'http://dev.winthehunt.com', // fill this out
		'ref_url'                => 'http://dev.winthehunt.com', // fill this out
		'nml_url'                => 'http://dev.winthehunt.com', // fill this out
		'serverName'             => 'dev.winthehunt.com', //  this isn't usually needed 
		'timezone'               => 'America/Chicago', // check the Time Zone article in the Knowledge Base for the correct syntax 
		'language'               => 'eng', // Three-letter only, eng = English. 
		'email'                  => 'admin@winthehunt.com', // fill this out and change it to desired email
...
// seconds/minutes, set that here. 0 = disabled
		...
		'maxCounterTime' 		 => 20, // if greater than zero, the time will not go past this point once this time is met.
...
// Please refer to documentation on this in our Knowledge Base (KB), or see the basic notes below	
		'buyNow' => array(
			'enabled'=>false,		// if false, buy-it-now feature is not available
			...
			'bid_price'=>0.01,		// how much each bid costs (used to calc discount)
			'before_closed'=>false,	// allow b-i-n before the auction closes
			'after_closed'=>false,	// allow b-i-n after the auction closes, 'SPLIT' *MUST* be set to true
			'hours_after_closed'=>0,	// can b-i-n up to X hours after listing closes
...
// products and categories. NB: Disabled by default.
		...
		'limits' => array(
			'active' => true,
				'limit' => 4,
				'expiry' => 1, // the number of days
		),
		
		'limits_t_daily' => array(
			'active' => false,
				'limit' => 3,
				'expiry' => 1, // the number of days
		),
		'limits_t_weekly' => array(
			'active' => false,
				'limit' => 500,
				'expiry' => 7, // the number of days
		),
		'limits_t_monthly' => array(
			'active' => false,
				'limit' => 1000,
				'expiry' => 30, // the number of days
		),
...
// are doing!
		...
		'cleaner' => array(
			'active' => true,
			'clear' => 90,     // the number of days the auctions should remain
			'clear_all' => 120, // the number of days until ALL auctions are deleted
		),
...
// PayPal 
        'Paypal' => array(
            ...
            'email' 	 => 'admin@winthehunt.com', //enter your default PayPal email address here. 
            'lc'    	 => 'USD',
        ),
...
// third-party option below (commented out by default).
        ...
        'Email' => array( 
            ...
            'Port'       => 25,
            'WordWrap'   => 50,
            'From'       => 'no-reply@winthehunt.com',  //fill this in
            'FromName'   => 'winthehunt.com', //fill this in with your chosen business/website name
            'ReplyTo'    => 'admin@winthehunt.com' //fill this in
